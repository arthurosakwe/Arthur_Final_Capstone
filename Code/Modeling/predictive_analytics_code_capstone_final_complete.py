...
class SocialMediaPredictiveModeling:    
    ...
    #function to help with model tuning
    ...
    def calculate_seasonal_patterns(self, client_name):
        ...
        #extract day of week and hour from date(future iteration review for datetime)
        engagement_data.loc[:, 'day'] = engagement_data['full_date'].dt.day_name()
        
        #engagement_data.loc[:, 'hour'] = engagement_data['full_date'].dt.hour
        
        # Group by day and hour
        #seasonal_patterns = engagement_data.groupby(['day', 'hour'])['value'].mean().reset_index()
    ...
    def _create_platform_pivot_table(self, engagement_data):
    ...
    def predict_engagement_two_part_model(self, client_name, platform, days=30):
        ...
        features_df = self._create_features_for_weekly_model(weekly_engagement)
    ...
    def _create_features_for_weekly_model(self, weekly_series):
